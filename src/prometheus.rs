...
lazy_static! {
    ...
    pub static ref USERS_WITH_ALL_FOUNDATION_NODE_REPLICA_SET_GAUGE: IntGaugeVec =
        ...
        .unwrap();
    pub static ref USERS_WITH_NO_FOUNDATION_NODE_REPLICA_SET_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref FULLY_SYNCED_USER_BY_PRIMARY_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref PARTIALLY_SYNCED_USER_BY_PRIMARY_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref UNSYNCED_USER_BY_PRIMARY_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref FULLY_SYNCED_USER_BY_REPLICA_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref PARTIALLY_SYNCED_USER_BY_REPLICA_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
    ...
    .unwrap();
    pub static ref UNSYNCED_USER_BY_REPLICA_COUNT_GAUGE: IntGaugeVec = register_int_gauge_vec!(
